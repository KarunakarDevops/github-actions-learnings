...
az deployment group create --resource-group group-bicep --template-file armtemplate.json 
...
az deployment group create --resource-group group-bicep --template-file biceptemplate.bicep --parameters biceptemplate.bicepparam

az deployment group create --resource-group group-bicep --template-file HelloWorld.bicep --parameters HelloWorld.bicepparam